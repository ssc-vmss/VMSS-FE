<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit :max-height="tableHeight">
      <el-table-column align="center" width="100" label="车牌号码">
        <template slot-scope="scope">
          {{ scope.row.LPNO }}
        </template>
      </el-table-column>
      <el-table-column label="车牌颜色" width="100" align="center">
        <template slot-scope="scope">
          {{ scope.row.Color }}
        </template>
      </el-table-column>
      <el-table-column label="车辆类型" width="150" align="center">
        <template slot-scope="scope">
          <span>{{ vehicleType(scope.row.Type) }}</span>
        </template>
      </el-table-column>
      <el-table-column label="车辆品牌" width="100" align="center">
        <template slot-scope="scope">
          {{ scope.row.plateBrand }}
        </template>
      </el-table-column>
      <el-table-column label="发动机号" width="100" align="center">
        <template slot-scope="scope">
          {{ scope.row.EngineNO }}
        </template>
      </el-table-column>
      <el-table-column label="发动机识别号" width="110" align="center">
        <template slot-scope="scope">
          {{ scope.row.engineId }}
        </template>
      </el-table-column>
      <el-table-column label="购置时间" width="110" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="企业编号" width="100" align="center">
        <template slot-scope="scope">
          {{ scope.row.EnterpriseNO }}
        </template>
      </el-table-column>
      <el-table-column label="排放标准" width="100" align="center">
        <template slot-scope="scope">
          {{ scope.row.Emission }}
        </template>
      </el-table-column>
      <el-table-column label="车载设备型号" width="110" align="center">
        <template slot-scope="scope">
          {{ scope.row.unitType }}
        </template>
      </el-table-column>
      <el-table-column label="设备SIM卡" width="100" align="center">
        <template slot-scope="scope">
          {{ scope.row.simNo }}
        </template>
      </el-table-column>
      <el-table-column label="是否开启防盗" width="110" align="center">
        <template slot-scope="scope">
    ...
    <el-dialog :title="dialogTitle+'车辆信息'" :visible.sync="dialogFormVisible" width="600px" @close="closeDialog('ruleForm')">
      <el-form :model="form" :rules="rules" ref="ruleForm">
        <el-row>
          <el-col :span="12">
            <el-form-item label="车牌号码" prop="LPNO" :label-width="formLabelWidth">
              <el-input type="text" v-model="form.LPNO"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="车牌颜色" prop="Color" :label-width="formLabelWidth">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="购置时间" prop="buyTimes" :label-width="formLabelWidth">
